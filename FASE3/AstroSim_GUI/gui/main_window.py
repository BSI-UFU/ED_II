...
class MainWindow(tb.Window):
    ...
    def create_widgets(self): # Método para criar os widgets da janela principal
        ...
        menu.add(ResourceManagerGUI(menu), text="Gerenciamento de Recursos") # Adiciona a aba de gerenciamento de recursos
        menu.add(ScienceAnalysisGUI(menu), text="Análise Científica") # Adiciona a aba de análise científica
